          ...
          <div class="wrapper">
            <div class="card testimonial-card mt-2 mb-3">
              ...
              <div class="card-body">
                ...
                <hr>
                <!-- Quotation -->
                <p><i class="fas fa-quote-left"></i> Приложение подстраивается под Вас и Ваш ритм, чтобы достичь наилучший результат</p>
              </div>
          </div>
        </li>
        <li class="main-page__mini-game">
          ...
          <div class="wrapper">
            <div class="card testimonial-card mt-2 mb-3">
              ...
              <div class="card-body">
                ...
                <hr>
                <!-- Quotation -->
                <p><i class="fas fa-quote-left"></i> Объедините популярное хобби и изучение английского языка</p>
              </div>
          </div>
        </li>
        <li class="main-page__mini-game">
          ...
          <div class="wrapper">
            <div class="card testimonial-card mt-2 mb-3">
              ...
              <div class="card-body">
                ...
                <hr>
                <!-- Quotation -->
                <p><i class="fas fa-quote-left"></i> Покоряйте Саванну, изучая английский и расширяя словарный запас</p>
              </div>
          </div>
        </li>
        <li class="main-page__mini-game">
          ...
          <div class="wrapper">
            <div class="card testimonial-card mt-2 mb-3">
              ...
              <div class="card-body">
                ...
                <hr>
                <!-- Quotation -->
                <p><i class="fas fa-quote-left"></i> Сопоставьте перевод слова и его английский эквивалент</p>
              </div>
          </div>
        </li>
        <li class="main-page__mini-game">
          ...
          <div class="wrapper">
            <div class="card testimonial-card mt-2 mb-3">
              ...
              <div class="card-body">
                ...
                <hr>
                <!-- Quotation -->
                <p><i class="fas fa-quote-left"></i> Тренируйте навык аудирования для наилучшего понимания речи</p>
              </div>
          </div>
        </li>
        <li class="main-page__mini-game">
          ...
          <div class="wrapper">
            <div class="card testimonial-card mt-2 mb-3">
              ...
              <div class="card-body">
                ...
                <hr>
                <!-- Quotation -->
                <p><i class="fas fa-quote-left"></i> Преобразите произношение слов на английском языке</p>
              </div>
          </div>
        </li>
        <li class="main-page__mini-game">
...
<path d="M29.9838 117.969H136.844V4.71875H29.6889C24.9483 4.73399 20.4063 6.62393 17.0542 9.97604C13.7021 13.3281 11.8121 17.8702 11.7969 22.6108V126.89H11.8001C11.8001 126.935 11.7969 126.979 11.7969 127.024C11.7969 137.464 19.9904 146.282 29.6889 146.282H136.844V136.844H29.6889C25.2642 136.844 21.2344 132.163 21.2344 127.023C21.2344 122.115 25.2409 117.969 29.9838 117.969ZM106.172 14.2545V65.2217L91.8977 52.6904L77.8594 65.1482V14.2545H106.172ZM68.4219 14.1562V77.8594H77.7535L91.9319 65.2783L106.262 77.8594H115.609V14.1562H127.406V108.531H40.133L40.1094 14.1562H68.4219ZM29.6889 14.1562H30.6719L30.6943 108.531H29.9826C26.9139 108.532 23.8985 109.333 21.2344 110.856V22.6845C21.2272 20.4332 22.1132 18.271 23.6982 16.6722C25.2832 15.0734 27.4376 14.1686 29.6889 14.1562Z" fill="#2E2E2E"/>
            ...
            <li class="main-page__addition">
              <div class="card-additions" id="card-additions-3">
                <svg class="card-additions-img" width="152" height="151" viewBox="0 0 152 151" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0)"><path d="M132.189 151H18.9394C13.7291 151 9.28069 149.157 5.59416 145.47C1.90764 141.784 0.0643768 137.335 0.0643768 132.125V18.875C0.0643768 13.6647 1.90764 9.21631 5.59416 5.52979C9.28069 1.84326 13.7291 0 18.9394 0H132.189C137.4 0 141.848 1.84326 145.535 5.52979C149.221 9.21631 151.064 13.6647 151.064 18.875V132.125C151.064 137.335 149.221 141.784 145.535 145.47C141.848 149.157 137.4 151 132.189 151V151ZM47.2519 108.531C47.2519 107.253 46.7849 106.147 45.851 105.213C44.9171 104.279 43.8111 103.812 42.5331 103.812H33.0956C31.8176 103.812 30.7117 104.279 29.7778 105.213C28.8438 106.147 28.3769 107.253 28.3769 108.531V127.406C28.3769 128.684 28.8438 129.79 29.7778 130.724C30.7117 131.658 31.8176 132.125 33.0956 132.125H42.5331C43.8111 132.125 44.9171 131.658 45.851 130.724C46.7849 129.79 47.2519 128.684 47.2519 127.406V108.531ZM85.0019 70.7812C85.0019 69.5033 84.5349 68.3973 83.601 67.4634C82.6671 66.5295 81.5611 66.0625 80.2831 66.0625H70.8456C69.5676 66.0625 68.4617 66.5295 67.5278 67.4634C66.5938 68.3973 66.1269 69.5033 66.1269 70.7812V127.406C66.1269 128.684 66.5938 129.79 67.5278 130.724C68.4617 131.658 69.5676 132.125 70.8456 132.125H80.2831C81.5611 132.125 82.6671 131.658 83.601 130.724C84.5349 129.79 85.0019 128.684 85.0019 127.406V70.7812ZM122.752 23.5938C122.752 22.3158 122.285 21.2098 121.351 20.2759C120.417 19.342 119.311 18.875 118.033 18.875H108.596C107.318 18.875 106.212 19.342 105.278 20.2759C104.344 21.2098 103.877 22.3158 103.877 23.5938V127.406C103.877 128.684 104.344 129.79 105.278 130.724C106.212 131.658 107.318 132.125 108.596 132.125H118.033C119.311 132.125 120.417 131.658 121.351 130.724C122.285 129.79 122.752 128.684 122.752 127.406V23.5938Z" fill="#2E2E2E"/></g>
                  <defs><clipPath id="clip0"><rect width="151.15" height="151" fill="white"/></clipPath></defs>
                </svg>
